...
class PredictionSystem:
    ...
    def event_created(
        ...
        if event_status == "ACTIVE":
            ...
            if streamer.is_online and event.closing_bet_after(timestamp) > 0:
                ...
                if (
                    ...
                    start_after = event.closing_bet_after(timestamp)
                    ...
                    prediction_event = None  # TODO make this type
    ...
    def event_updated(
        ...
        if (
            ...
            self.prediction_events[event_id].bet.update_outcomes(event_dict["outcomes"])
    ...
    def prediction_result(
        ...
        if event_prediction is None:
            ...
            return
        streamer = find_streamer(self.streamers, channel_id)
        points = event_prediction.parse_result(result_dict["result"])
    ...
    def user_prediction_made(self, channel_id: str, event_dict: dict):
        event_id = event_dict["id"]
        event_prediction = self.prediction_events.get(event_id, None)
        if event_prediction is None:
